...
function Buys() {
	return(
		<div className="Buys animate__animated animate__bounceInUp">
			<details className="info__section">
				<summary className="section__subtitle">Paquete 1</summary>
			...
			<details className="info__section">
				<summary className="section__subtitle">Paquete 2</summary>
			...
			<details className="info__section">
				<summary className="section__subtitle">Paquete 3</summary>
